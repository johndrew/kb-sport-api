...
describe(__filename, () => {
    ...
    describe('Positive Tests', () => {
        ...
        describe(weightClasses.STRAWWEIGHT, () => {
            ...
            it('returns CMS for repetitions greater than or equal to 55', async function i() {
            ...
            it('returns Rank I for repetitions less than 55 and greater than or equal to 43', async function i() {
                this.timeout(timeout);
            ...
            it('returns Rank II for repetitions less than 43 and greater than or equal to 34', async function i() {
                this.timeout(timeout);
            ...
            it('returns Rank III for repetitions less than 34 and greater than or equal to 28', async function i() {
                this.timeout(timeout);
