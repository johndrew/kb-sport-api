...
describe(__filename, () => {
  ...
  describe('Negative Tests', () => {
    ...
    describe(weightClasses.BANTAMWEIGHT, () => {
      ...
      it('returns no rank for repetitions less than 26', async function i() {
        this.timeout(timeout);
    ...
    describe(weightClasses.FEATHERWEIGHT, () => {
      ...
      it('returns no rank for repetitions less than 29', async function i() {
        this.timeout(timeout);
    ...
    describe(weightClasses.LIGHTWEIGHT, () => {
      ...
      it('returns no rank for repetitions less than 32', async function i() {
        this.timeout(timeout);
    ...
    describe(weightClasses.SUPER_LIGHTWEIGHT, () => {
      ...
      it('returns no rank for repetitions less than 35', async function i() {
        this.timeout(timeout);
    ...
    describe(weightClasses.WELTERWEIGHT, () => {
      ...
      it('returns no rank for repetitions less than 38', async function i() {
        this.timeout(timeout);
    ...
    describe(weightClasses.CRUISERWEIGHT, () => {
      ...
      it('returns no rank for repetitions less than 44', async function i() {
        this.timeout(timeout);
    ...
    describe(weightClasses.SUPER_HEAVYWEIGHT, () => {
      ...
      it('returns no rank for repetitions less than 46', async function i() {
        this.timeout(timeout);
