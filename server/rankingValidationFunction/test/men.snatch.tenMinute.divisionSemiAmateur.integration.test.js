...
describe(__filename, () => {
    ...
    describe('Positive Tests', () => {
        ...
        describe(weightClasses.SUPER_MIDDLEWEIGHT, () => {
            ...
            it('returns Rank II for repetitions less than 204 and greater than or equal to 165', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 165; i < 204; i++) testRepetitions.push(i);
            ...
            it('returns Rank III for repetitions less than 165 and greater than or equal to 133', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 133; i < 165; i++) testRepetitions.push(i);
        ...
        describe(weightClasses.CRUISERWEIGHT, () => {
            ...
            it('returns Rank I for repetitions greater than or equal to 211', async function i() {
                this.timeout(timeout);
            ...
            it('returns Rank II for repetitions less than 211 and greater than or equal to 171', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 171; i < 211; i++) testRepetitions.push(i);
            ...
            it('returns Rank III for repetitions less than 171 and greater than or equal to 137', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 137; i < 171; i++) testRepetitions.push(i);
        ...
        describe(weightClasses.HEAVYWEIGHT, () => {
            ...
            it('returns Rank I for repetitions greater than or equal to 218', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 218; i < 250; i++) testRepetitions.push(i);
            ...
            it('returns Rank II for repetitions less than 218 and greater than or equal to 176', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 176; i < 218; i++) testRepetitions.push(i);
            ...
            it('returns Rank III for repetitions less than 176 and greater than or equal to 140', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 140; i < 176; i++) testRepetitions.push(i);
        ...
        describe(weightClasses.SUPER_HEAVYWEIGHT, () => {
            ...
            it('returns Rank I for repetitions greater than or equal to 223', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 223; i < 250; i++) testRepetitions.push(i);
            ...
            it('returns Rank II for repetitions less than 223 and greater than or equal to 179', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 179; i < 223; i++) testRepetitions.push(i);
            ...
            it('returns Rank III for repetitions less than 179 and greater than or equal to 143', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 143; i < 179; i++) testRepetitions.push(i);
    ...
    describe('Negative Tests', () => {
        ...
        describe(weightClasses.SUPER_MIDDLEWEIGHT, () => {
            ...
            it('returns no rank for repetitions less than 133', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 0; i < 133; i++) testRepetitions.push(i);
        ...
        describe(weightClasses.CRUISERWEIGHT, () => {
            ...
            it('returns no rank for repetitions less than 137', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 0; i < 137; i++) testRepetitions.push(i);
        ...
        describe(weightClasses.HEAVYWEIGHT, () => {
            ...
            it('returns no rank for repetitions less than 140', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 0; i < 140; i++) testRepetitions.push(i);
        ...
        describe(weightClasses.SUPER_HEAVYWEIGHT, () => {
            ...
            it('returns no rank for repetitions less than 143', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 0; i < 143; i++) testRepetitions.push(i);
