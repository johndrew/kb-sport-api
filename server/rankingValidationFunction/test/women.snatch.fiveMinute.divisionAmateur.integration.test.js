...
describe(__filename, () => {
    ...
    describe('Positive Tests', () => {
        ...
        describe(weightClasses.STRAWWEIGHT, () => {
            ...
            it('returns Rank I for repetitions less than 76 and greater than or equal to 62', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 62; i < 76; i++) testRepetitions.push(i);
        ...
        describe(weightClasses.FLYWEIGHT, () => {
            ...
            it('returns CMS for repetitions greater than or equal to 82', async function i() {
                ...
                const testRepetitions = [];
                for (let i = 82; i < 110; i++) testRepetitions.push(i);
            ...
            it('returns Rank I for repetitions less than 82 and greater than or equal to 67', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 67; i < 82; i++) testRepetitions.push(i);
            ...
            it('returns Rank II for repetitions less than 67 and greater than or equal to 54', async function i() {
                ...
                const testRepetitions = [];
                for (let i = 54; i < 67; i++) testRepetitions.push(i);
