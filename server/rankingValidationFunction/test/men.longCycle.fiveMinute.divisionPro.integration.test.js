...
describe(__filename, () => {
    ...
    describe('Positive Tests', () => {
        ...
        describe(weightClasses.SUPER_MIDDLEWEIGHT, () => {
            ...
            it('returns CMS for repetitions greater than or equal to 34', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 34; i < 60; i++) testRepetitions.push(i);
            ...
            it('returns Rank I for repetitions less than 34 and greater than or equal to 29', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 29; i < 34; i++) testRepetitions.push(i);
            ...
            it('returns Rank II for repetitions less than 29 and greater than or equal to 23', async function i() {
                this.timeout(timeout);
        ...
        describe(weightClasses.CRUISERWEIGHT, () => {
            ...
            it('returns Rank I for repetitions less than 35 and greater than or equal to 30', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 30; i < 35; i++) testRepetitions.push(i);
        ...
        describe(weightClasses.HEAVYWEIGHT, () => {
            ...
            it('returns Rank I for repetitions less than 36 and greater than or equal to 31', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 31; i < 36; i++) testRepetitions.push(i);
            ...
            it('returns Rank II for repetitions less than 31 and greater than or equal to 26', async function i() {
                this.timeout(timeout);
        ...
        describe(weightClasses.SUPER_HEAVYWEIGHT, () => {
            ...
            it('returns CMS for repetitions greater than or equal to 37', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 37; i < 70; i++) testRepetitions.push(i);
            ...
            it('returns Rank I for repetitions less than 37 and greater than or equal to 32', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 32; i < 37; i++) testRepetitions.push(i);
            ...
            it('returns Rank II for repetitions less than 32 and greater than or equal to 27', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 27; i < 32; i++) testRepetitions.push(i);
