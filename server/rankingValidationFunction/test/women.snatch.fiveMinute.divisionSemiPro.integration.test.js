...
describe(__filename, () => {
    ...
    describe('Positive Tests', () => {
        ...
        describe(weightClasses.STRAWWEIGHT, () => {
            ...
            it('returns Rank I for repetitions less than 66 and greater than or equal to 47', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 47; i < 66; i++) testRepetitions.push(i);
            ...
            it('returns Rank II for repetitions less than 47 and greater than or equal to 37', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 37; i < 47; i++) testRepetitions.push(i);
            ...
            it('returns Rank III for repetitions less than 37 and greater than or equal to 30', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 30; i < 37; i++) testRepetitions.push(i);
        ...
        describe(weightClasses.FLYWEIGHT, () => {
            ...
            it('returns Rank I for repetitions less than 70 and greater than or equal to 52', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 52; i < 70; i++) testRepetitions.push(i);
