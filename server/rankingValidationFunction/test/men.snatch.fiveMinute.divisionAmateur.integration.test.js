...
describe(__filename, () => {
    ...
    describe('Positive Tests', () => {
        ...
        describe(weightClasses.BANTAMWEIGHT, () => {
            ...
            it('returns CMS for repetitions greater than or equal to 89', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 89; i < 120; i++) testRepetitions.push(i);
            ...
            it('returns Rank I for repetitions less than 89 and greater than or equal to 73', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 73; i < 89; i++) testRepetitions.push(i);
            ...
            it('returns Rank III for repetitions less than 58 and greater than or equal to 47', async function i() {
                ...
                const testRepetitions = [];
                for (let i = 47; i < 58; i++) testRepetitions.push(i);
        ...
        describe(weightClasses.FEATHERWEIGHT, () => {
            ...
            it('returns Rank I for repetitions less than 96 and greater than or equal to 79', async function i() {
                this.timeout(timeout);
        ...
        describe(weightClasses.LIGHTWEIGHT, () => {
            ...
            it('returns Rank I for repetitions less than 103 and greater than or equal to 86', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 86; i < 103; i++) testRepetitions.push(i);
        ...
        describe(weightClasses.SUPER_LIGHTWEIGHT, () => {
            ...
            it('returns CMS for repetitions greater than or equal to 110', async function i() {
                ...
                const testRepetitions = [];
                for (let i = 110; i < 140; i++) testRepetitions.push(i);
            ...
            it('returns Rank I for repetitions less than 110 and greater than or equal to 92', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 92; i < 110; i++) testRepetitions.push(i);
            ...
            it('returns Rank II for repetitions less than 92 and greater than or equal to 74', async function i() {
                this.timeout(timeout);
        ...
        describe(weightClasses.WELTERWEIGHT, () => {
            ...
            it('returns Rank I for repetitions less than 116 and greater than or equal to 98', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 98; i < 116; i++) testRepetitions.push(i);
            ...
            it('returns Rank II for repetitions less than 98 and greater than or equal to 78', async function i() {
                this.timeout(timeout);
            ...
            it('returns Rank III for repetitions less than 78 and greater than or equal to 62', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 62; i < 78; i++) testRepetitions.push(i);
        ...
        describe(weightClasses.SUPER_MIDDLEWEIGHT, () => {
            ...
            it('returns Rank I for repetitions less than 127 and greater than or equal to 107', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 107; i < 127; i++) testRepetitions.push(i);
        ...
        describe(weightClasses.CRUISERWEIGHT, () => {
            ...
            it('returns Rank I for repetitions less than 131 and greater than or equal to 110', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 110; i < 131; i++) testRepetitions.push(i);
            ...
            it('returns Rank II for repetitions less than 110 and greater than or equal to 88', async function i() {
                this.timeout(timeout);
            ...
            it('returns Rank III for repetitions less than 88 and greater than or equal to 71', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 71; i < 88; i++) testRepetitions.push(i);
        ...
        describe(weightClasses.HEAVYWEIGHT, () => {
            ...
            it('returns CMS for repetitions greater than or equal to 135', async function i() {
                this.timeout(timeout);
            ...
            it('returns Rank I for repetitions less than 135 and greater than or equal to 113', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 113; i < 135; i++) testRepetitions.push(i);
        ...
        describe(weightClasses.SUPER_HEAVYWEIGHT, () => {
            ...
            it('returns CMS for repetitions greater than or equal to 139', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 139; i < 170; i++) testRepetitions.push(i);
            ...
            it('returns Rank I for repetitions less than 139 and greater than or equal to 116', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 116; i < 139; i++) testRepetitions.push(i);
            ...
            it('returns Rank II for repetitions less than 116 and greater than or equal to 93', async function i() {
                this.timeout(timeout);
            ...
            it('returns Rank III for repetitions less than 93 and greater than or equal to 74', async function i() {
                this.timeout(timeout);
    ...
    describe('Negative Tests', () => {
        ...
        describe(weightClasses.BANTAMWEIGHT, () => {
            ...
            it('should return no rank for repetitions less than 47', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 0; i < 47; i++) testRepetitions.push(i);
