...
describe(__filename, () => {
    ...
    describe('Positive Tests', () => {
        ...
        describe(weightClasses.SUPER_MIDDLEWEIGHT, () => {
            ...
            it('returns Rank II for repetitions less than 180 and greater than or equal to 142', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 142; i < 180; i++) testRepetitions.push(i);
            ...
            it('returns Rank III for repetitions less than 142 and greater than or equal to 115', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 115; i < 142; i++) testRepetitions.push(i);
        ...
        describe(weightClasses.CRUISERWEIGHT, () => {
            ...
            it('returns Rank I for repetitions greater than or equal to 188', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 188; i < 220; i++) testRepetitions.push(i);
            ...
            it('returns Rank II for repetitions less than 188 and greater than or equal to 149', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 149; i < 188; i++) testRepetitions.push(i);
            ...
            it('returns Rank III for repetitions less than 149 and greater than or equal to 120', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 120; i < 149; i++) testRepetitions.push(i);
        ...
        describe(weightClasses.HEAVYWEIGHT, () => {
            ...
            it('returns Rank I for repetitions greater than or equal to 195', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 195; i < 230; i++) testRepetitions.push(i);
            ...
            it('returns Rank II for repetitions less than 195 and greater than or equal to 155', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 155; i < 195; i++) testRepetitions.push(i);
            ...
            it('returns Rank III for repetitions less than 155 and greater than or equal to 125', async function i() {
                this.timeout(timeout);
        ...
        describe(weightClasses.SUPER_HEAVYWEIGHT, () => {
            ...
            it('returns Rank I for repetitions greater than or equal to 200', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 200; i < 230; i++) testRepetitions.push(i);
            ...
            it('returns Rank II for repetitions less than 200 and greater than or equal to 160', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 160; i < 200; i++) testRepetitions.push(i);
            ...
            it('returns Rank III for repetitions less than 160 and greater than or equal to 128', async function i() {
                this.timeout(timeout);
    ...
    describe('Negative Tests', () => {
        ...
        describe(weightClasses.SUPER_MIDDLEWEIGHT, () => {
            ...
            it('should return no rank for repetitions less than 115', async function i() {
                this.timeout(timeout);
        ...
        describe(weightClasses.CRUISERWEIGHT, () => {
            ...
            it('should return no rank for repetitions less than 120', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 0; i < 120; i++) testRepetitions.push(i);
        ...
        describe(weightClasses.HEAVYWEIGHT, () => {
            ...
            it('should return no rank for repetitions less than 125', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 0; i < 125; i++) testRepetitions.push(i);
        ...
        describe(weightClasses.SUPER_HEAVYWEIGHT, () => {
            ...
            it('should return no rank for repetitions less than 128', async function i() {
                this.timeout(timeout);
