...
describe(__filename, () => {
    ...
    describe('Positive Tests', () => {
        ...
        describe(weightClasses.CRUISERWEIGHT, () => {
            ...
            it('returns CMS for repetitions greater than or equal to 51', async function i() {
                this.timeout(timeout);
            ...
            it('returns Rank I for repetitions less than 51 and greater than or equal to 43', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 43; i < 51; i++) testRepetitions.push(i);
        ...
        describe(weightClasses.HEAVYWEIGHT, () => {
            ...
            it('returns Rank I for repetitions less than 53 and greater than or equal to 44', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 44; i < 53; i++) testRepetitions.push(i);
