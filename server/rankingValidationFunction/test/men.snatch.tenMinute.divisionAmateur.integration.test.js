...
describe(__filename, () => {
    ...
    describe('Positive Tests', () => {
        ...
        describe(weightClasses.SUPER_MIDDLEWEIGHT, () => {
            ...
            it('returns CMS for repetitions greater than or equal to 211', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 211; i < 240; i++) testRepetitions.push(i);
            ...
            it('returns Rank I for repetitions less than 211 and greater than or equal to 170', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 170; i < 211; i++) testRepetitions.push(i);
            ...
            it('returns Rank II for repetitions less than 170 and greater than or equal to 135', async function i() {
                this.timeout(timeout);
            ...
            it('returns Rank III for repetitions less than 135 and greater than or equal to 108', async function i() {
                this.timeout(timeout);
        ...
        describe(weightClasses.CRUISERWEIGHT, () => {
            ...
            it('returns CMS for repetitions greater than or equal to 218', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 218; i < 240; i++) testRepetitions.push(i);
            ...
            it('returns Rank I for repetitions less than 218 and greater than or equal to 175', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 175; i < 218; i++) testRepetitions.push(i);
            ...
            it('returns Rank II for repetitions less than 175 and greater than or equal to 140', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 140; i < 175; i++) testRepetitions.push(i);
            ...
            it('returns Rank III for repetitions less than 140 and greater than or equal to 112', async function i() {
                this.timeout(timeout);
        ...
        describe(weightClasses.HEAVYWEIGHT, () => {
            ...
            it('returns CMS for repetitions greater than or equal to 225', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 225; i < 250; i++) testRepetitions.push(i);
            ...
            it('returns Rank I for repetitions less than 225 and greater than or equal to 180', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 180; i < 225; i++) testRepetitions.push(i);
            ...
            it('returns Rank II for repetitions less than 180 and greater than or equal to 144', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 144; i < 180; i++) testRepetitions.push(i);
            ...
            it('returns Rank III for repetitions less than 144 and greater than or equal to 115', async function i() {
                this.timeout(timeout);
        ...
        describe(weightClasses.SUPER_HEAVYWEIGHT, () => {
            ...
            it('returns CMS for repetitions greater than or equal to 231', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 231; i < 260; i++) testRepetitions.push(i);
            ...
            it('returns Rank I for repetitions less than 231 and greater than or equal to 184', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 184; i < 231; i++) testRepetitions.push(i);
            ...
            it('returns Rank II for repetitions less than 184 and greater than or equal to 148', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 148; i < 184; i++) testRepetitions.push(i);
            ...
            it('returns Rank III for repetitions less than 148 and greater than or equal to 118', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 118; i < 148; i++) testRepetitions.push(i);
    ...
    describe('Negative Tests', () => {
        ...
        describe(weightClasses.SUPER_MIDDLEWEIGHT, () => {
            ...
            it('returns no rank for repetitions less than 108', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 0; i < 108; i++) testRepetitions.push(i);
        ...
        describe(weightClasses.CRUISERWEIGHT, () => {
            ...
            it('returns no rank for repetitions less than 112', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 0; i < 112; i++) testRepetitions.push(i);
        ...
        describe(weightClasses.SUPER_HEAVYWEIGHT, () => {
            ...
            it('returns no rank for repetitions less than 118', async function i() {
                this.timeout(timeout);
            
                const testRepetitions = [];
                for (let i = 0; i < 118; i++) testRepetitions.push(i);
